...
//        setFilterProcessesUrl("/api/v1/members/login/email");
//    }
//
//    @Override
...
//
//        // ✅ JWT 생성 (email 기반)
//        String token = jwtUtil.createJwt(email, role, JwtConstants.ACCESS_TOKEN_EXPIRATION); // 10시간
...
//
//        String errorMessage = "로그인에 실패했습니다."; // 기본 메시지
//
...
//        } else if (failed.getMessage().equals("이메일이 존재하지 않습니다.")) {
//            errorMessage = "이메일이 존재하지 않습니다.";
//        } else if (failed.getMessage().equals("이메일 인증이 완료되지 않았습니다.")) {

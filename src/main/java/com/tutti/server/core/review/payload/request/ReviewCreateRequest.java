...
public record ReviewCreateRequest(
    ...
    @NotNull(message = "리뷰 작성자 이메일은 필수입니다.")
    String email,
    ...
    public ReviewCreateRequest withEmail(String userEmail) {
        return new ReviewCreateRequest(productId, userEmail, rating, content, nickname,
            reviewImages);
    }
}
